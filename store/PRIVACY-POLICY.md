...
information.** Everything you create with it stays on your own device.

## Data stored locally on your device

The Extension stores the following in your browser's local storage
(`chrome.storage.local` / `localStorage`) only:
...
This data never leaves your browser. It is not sent to us or to any third
party. You can export or delete it at any time from the Extension's settings.
