...
export const koreanTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Poe Zh Trade Tools Pro 패널 복원",
  "popup.description":
    "Poe Zh Trade Tools Pro는 공식 Path of Exile 거래 사이트에 더 빠른 탐색과 거래 도우미 기능을 추가합니다.",
  ...
  "settings.sidebarDescription":
    "Poe Zh Trade Tools Pro 패널을 화면 어느 쪽에 표시할지 선택하세요.",
  "settings.left": "왼쪽",
  "settings.right": "오른쪽",
  ...
  "about.eyebrow": "정보",
  "about.description":
    "Poe Zh Trade Tools Pro는 Path of Exile Trade용 보조 도구로, 검색 저장, 폴더 정리, 기록 추적을 지원하며 반복적인 거래 작업을 공식 사이트 안에서 빠르고 보기 쉽게 관리할 수 있게 해줍니다.",
  ...
  "folder.addSubfolder": "하위 폴더 추가",
  "folder.moveToFolder": "폴더로 이동",
  "folder.movedTrade": ({ title, folder }) => `"${title}"을(를) ${folder}(으)로 이동함`,
  "folder.noOtherFolders": "다른 폴더가 없습니다",
