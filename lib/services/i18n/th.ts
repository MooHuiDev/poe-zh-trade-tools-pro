...
export const thaiTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "กู้คืนแผง Poe Zh Trade Tools Pro",
  "popup.description":
    "Poe Zh Trade Tools Pro เพิ่มการนำทางที่เร็วขึ้นและเครื่องมือช่วยเทรดให้กับเว็บไซต์ซื้อขาย Path of Exile อย่างเป็นทางการ",
  ...
  "settings.sidebarDescription":
    "เลือกด้านของหน้าจอที่ต้องการให้แผง Poe Zh Trade Tools Pro แสดงผล",
  "settings.left": "ซ้าย",
  "settings.right": "ขวา",
  ...
  "about.description":
    "Poe Zh Trade Tools Pro เป็นส่วนเสริมสำหรับ Path of Exile Trade ที่สร้างขึ้นเพื่อบันทึกการค้นหา จัดระเบียบโฟลเดอร์ ติดตามประวัติ และทำให้การซื้อขายที่ทำซ้ำบ่อยรวดเร็ว มองเห็นได้ง่าย และจัดการได้สะดวกภายในเว็บไซต์ทางการ",
  ...
  "folder.addSubfolder": "เพิ่มโฟลเดอร์ย่อย",
  "folder.moveToFolder": "ย้ายไปยังโฟลเดอร์",
  "folder.movedTrade": ({ title, folder }) => `ย้าย "${title}" ไปยัง ${folder} แล้ว`,
  "folder.noOtherFolders": "ไม่มีโฟลเดอร์อื่น",
