...
export const germanTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Poe Zh Trade Tools Pro-Panel wiederherstellen",
  "popup.description":
    "Poe Zh Trade Tools Pro fügt der offiziellen Path of Exile-Handelsseite schnellere Navigation und Handelshilfen hinzu.",
  ...
  "settings.sidebarDescription":
    "Wähle, auf welcher Seite des Bildschirms das Poe Zh Trade Tools Pro-Panel erscheinen soll.",
  "settings.left": "Links",
  ...
  "about.description":
    "Poe Zh Trade Tools Pro ist ein Begleiter für Path of Exile Trade, entwickelt zum Speichern von Suchen, Organisieren von Ordnern, Nachverfolgen des Verlaufs und für schnelle, übersichtliche wiederkehrende Handelsabläufe direkt auf der offiziellen Seite.",
  ...
  "folder.addSubfolder": "Unterordner hinzufügen",
  "folder.moveToFolder": "In Ordner verschieben",
  "folder.movedTrade": ({ title, folder }) => `"${title}" nach ${folder} verschoben`,
  "folder.noOtherFolders": "Keine anderen Ordner",
