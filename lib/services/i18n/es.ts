...
export const spanishTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Restaurar panel de Poe Zh Trade Tools Pro",
  "layout.versionNoticeEyebrow": "Nueva versión",
  "layout.versionNoticeMessage": ({ version }) =>
    `Poe Zh Trade Tools Pro se actualizó a la versión ${version}.`,
  ...
  "welcome.title": "Bienvenido a Poe Zh Trade Tools Pro",
  "welcome.message":
  ...
  "onboarding.title": "Bienvenido a Poe Zh Trade Tools Pro",
  "onboarding.subtitle":
  ...
  "popup.description":
    "Poe Zh Trade Tools Pro agrega navegación más rápida y ayudas de trade al sitio oficial de Path of Exile.",
  ...
  "settings.sidebarDescription":
    "Elegí en qué lado de la pantalla querés que aparezca el panel de Poe Zh Trade Tools Pro.",
  ...
  "about.description":
    "Poe Zh Trade Tools Pro es un complemento para Path of Exile Trade creado para guardar búsquedas, organizar carpetas, seguir el historial y hacer que los flujos de trade repetidos sean rápidos, visuales y fáciles de manejar dentro del sitio oficial.",
  "about.github": "GitHub",
  ...
  "folder.addSubfolder": "Añadir subcarpeta",
  "folder.moveToFolder": "Mover a carpeta",
  "folder.movedTrade": ({ title, folder }) => `Se movió "${title}" a ${folder}`,
  "folder.noOtherFolders": "No hay otras carpetas",
