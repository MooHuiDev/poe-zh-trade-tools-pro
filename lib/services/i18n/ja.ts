...
export const japaneseTranslations: Record<string, TranslationValue> = {
  ...
  "layout.restorePanel": "Poe Zh Trade Tools Pro パネルを復元",
  "popup.description":
    "Poe Zh Trade Tools Pro は Path of Exile 公式トレードサイトに、より高速なナビゲーションと取引支援機能を追加します。",
  ...
  "settings.sidebarDescription":
    "Poe Zh Trade Tools Pro パネルを画面のどちら側に表示するか選択してください。",
  "settings.left": "左",
  "settings.right": "右",
  ...
  "about.eyebrow": "概要",
  "about.description":
    "Poe Zh Trade Tools Pro は Path of Exile Trade 用の補助ツールで、検索の保存、フォルダー整理、履歴管理を行い、繰り返し使うトレード作業を公式サイト上で素早く見やすく簡単に管理できるようにします。",
  ...
  "folder.addSubfolder": "サブフォルダーを追加",
  "folder.moveToFolder": "フォルダーへ移動",
  "folder.movedTrade": ({ title, folder }) => `「${title}」を${folder}へ移動しました`,
  "folder.noOtherFolders": "他のフォルダーがありません",
