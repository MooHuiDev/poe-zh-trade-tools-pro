...
export const frenchTranslations: Record<string, TranslationValue> = {
  "settings.bookmarkSyncTitle": "Synchroniser les favoris entre appareils",
  "settings.bookmarkSyncDescription": "Synchronise vos favoris et dossiers entre les appareils connectés au même compte de navigateur. Désactivé par défaut — désactivé, tout reste sur cet appareil.",
  "settings.bookmarkSyncEnabled": "Synchronisation des favoris activée",
  "settings.bookmarkSyncStatus": ({ time }) => `Dernière synchronisation : ${time}`,
  "settings.bookmarkSyncQuota": "Le stockage de synchronisation est plein — vos favoris restent sur cet appareil mais peuvent ne pas se synchroniser entièrement.",
  "settings.bookmarkSyncError": "La synchronisation a rencontré un problème — vos favoris sont en sécurité sur cet appareil.",
  ...englishTranslations,
  ...
  "layout.restorePanel": "Restaurer le panneau Poe Zh Trade Tools Pro",
  "popup.description":
    "Poe Zh Trade Tools Pro ajoute une navigation plus rapide et des aides de trade au site officiel de Path of Exile.",
  ...
  "settings.sidebarDescription":
    "Choisissez de quel côté de l’écran le panneau Poe Zh Trade Tools Pro doit apparaître.",
  ...
  "about.description":
    "Poe Zh Trade Tools Pro est un compagnon pour Path of Exile Trade conçu pour sauvegarder des recherches, organiser des dossiers, suivre l’historique et garder les routines de trade rapides, visuelles et faciles à gérer directement sur le site officiel.",
  ...
  "folder.addSubfolder": "Ajouter un sous-dossier",
  "folder.moveToFolder": "Déplacer vers un dossier",
  "folder.movedTrade": ({ title, folder }) => `"${title}" déplacé vers ${folder}`,
  "folder.noOtherFolders": "Aucun autre dossier",
