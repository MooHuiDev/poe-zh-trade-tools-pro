...
export const portugueseTranslations: Record<string, TranslationValue> = {
  ...
  "folder.addSubfolder": "Adicionar subpasta",
  "folder.moveToFolder": "Mover para pasta",
  "folder.movedTrade": ({ title, folder }) => `"${title}" movido para ${folder}`,
  "folder.noOtherFolders": "Sem outras pastas",
